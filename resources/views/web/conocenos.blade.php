<x-app-layout>
    ...
    <div class="container ">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 py-6 xl:py-20 mx-6 md:mx-0 top_naranja">
            <div class="text-justify">
                <h1 class="text-2xl font-bold top_verde">¿Quiénes somos?</h1>
                <p class="mb-8 mt-2">
                    Somos <span class="font-bold top_verde">DISTRIBUIDORA SUMON</span>, una empresa con más de 40 años de
                ...
                <p class="mb-8 mt-2 space-">Nuestro respaldo durante todos nuestros años han sido nuestros más de 6000
                    productos a disposición de nuestros clientes y la propuesta de valor que les ofrecemos: <span
                        class="font-bold top_verde"> productos originales, de valor, calidad y confiabilidad que los acompañan
                ...
                <p class="mb-8 mt-2">Durante estos años en el mercado, hemos marcado la diferencia adaptándonos a
                    ...
                    distribuidor sino <span class="font-bold top_verde"> IMPORTADOR</span> de reconocidas marcas a nivel
                    internacional, las cuales ponemos a su disposición en nuestro amplio portafolio.</p>

                <h1 class="text-2xl font-bold top_verde">Nuestra Visión</h1>
                ...
                <h1 class="text-2xl font-bold top_verde">Nuestra Misión</h1>
