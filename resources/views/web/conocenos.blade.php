<x-app-layout>
    ...
    <div class="container  pb-8">
        ...
        <p class="text-center mt-6 lg:mt-14 text-xl md:text-2xl font-semibold">Vive experiencias de los Tours, Full Days y
            actividades
        </p>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-14 mt-6 lg:mt-10 xl:mt-14 mx-6 md:mx-0 pb-8">
            <div class="text-center">
                <div>
                    <i class="fa-solid fa-plane fa-2x text-purple-600"></i>
                    <h1 class="mt-3 font-semibold">Experiencia Certificada</h1>
                    <p class="text-justify mt-5">Amplia experiencia en viajes corporativos, atendemos una cartera de
                        importantes empresas privadas y estatales, gracias a esto también brindamos más</p>
                </div>
            </div>
            <div class="text-center">
                <div>
                    <i class="fa-solid fa-users fa-2x text-purple-600"></i>
                    <h1 class="mt-3 font-semibold">Experiencia Certificada</h1>
                    <p class="text-justify mt-5">Amplia experiencia en viajes corporativos, atendemos una cartera de
                        importantes empresas privadas y estatales, gracias a esto también brindamos más</p>
                </div>
            ...
            <div class="text-center">
                <div>
                    <i class="fa-solid fa-ticket fa-2x text-purple-600"></i>
                    <h1 class="mt-3 font-semibold">Experiencia Certificada</h1>
                    <p class="text-justify mt-5">Amplia experiencia en viajes corporativos, atendemos una cartera de
                        importantes empresas privadas y estatales, gracias a esto también brindamos más</p>
                </div>
