<div class="bg-gray-100">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 xl:gap-8 ">
        ...
        <aside class="category_filter_web rounded-lg">
            ...
            <div id="container-main mt-4 ">
                ...
                <hr class="pb-6">
                <div class="accordion-container">
                    <a class="accordion-titulo open">Subategorías <span class="toggle-icon"></span></a>
                    <div class="accordion-content block">
                        <ul class="divide-y divide-gray-200">
                            ...
                            <article class=" overflow-hidden bg-white rounded-xl zoomcatalg ">
                                ...
                                <a href="{{ route('products.show', $product) }}">
                                    ...
                                    <div class="py-2 px-2">
                                        ...
                                        <h1
                                            class="text-xs text-left font-medium scrollflow -slide-bottom -opacity">
    ...
    <div
        class="modal h-screen w-full  z-40 fixed left-0 top-0 flex justify-center items-center bg-black bg-opacity-50 hidden">
        <!-- modal -->
